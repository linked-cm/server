...
var LocalFileStore_js_1 = require("./shapes/filestores/LocalFileStore.js");
...
var LincdServerBackendProvider = /** @class */ (function (_super) {
    __extends(LincdServerBackendProvider, _super);
    function LincdServerBackendProvider() {
        return _super !== null && _super.apply(this, arguments) || this;
    }
    LincdServerBackendProvider.prototype.setupBeforeControllers = function () {
        return __awaiter(this, void 0, void 0, function () {
            var fileSystemUploadPath, err_1;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    ...
                    case 1:
                        _a.trys.push([1, 3, , 5]);
                        return [4 /*yield*/, promises_1.default.access(fileSystemUploadPath)];
                    case 2:
                        _a.sent();
                        return [3 /*break*/, 5];
                    case 3:
                        err_1 = _a.sent();
                        return [4 /*yield*/, promises_1.default.mkdir(path_1.default.join(fileSystemUploadPath, 'filestores'), {
                                recursive: true,
                            })];
                    case 4:
                        _a.sent();
    ...
    LincdServerBackendProvider.prototype.getShapes = function () {
        return (0, Shapes_js_1.getShapeIndex)();
    };
    return LincdServerBackendProvider;
