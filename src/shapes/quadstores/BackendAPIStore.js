 ...
 */
var BackendAPIStore = /** @class */ (function (_super) {
    __extends(BackendAPIStore, _super);
    function BackendAPIStore(n) {
        var _this = this;
        if (typeof n === 'string') {
            var uri = "".concat(process.env.DATA_ROOT, "/backend-api-store/").concat(n);
    ...
    BackendAPIStore.prototype.init = function () {
    ...
    BackendAPIStore.prototype.selectQuery = function (query) {
        var queryObj = typeof query.getQueryObject === 'function'
            ? query.getQueryObject()
            : query;
        return Server_1.Server.call(this, 'selectQuery', queryObj);
    };
    BackendAPIStore.prototype.updateQuery = function (query) {
        return Server_1.Server.call(this, 'updateQuery', query);
    };
    BackendAPIStore.prototype.createQuery = function (query) {
        return Server_1.Server.call(this, 'createQuery', query);
    };
    BackendAPIStore.prototype.deleteQuery = function (query) {
